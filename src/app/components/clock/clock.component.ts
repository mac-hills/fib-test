...
export class ClockComponent implements OnInit {
  ...
  // These properties will now be updated from the service
  colorWhenUsedForHoursAndMinutes!: string;
  colorWhenUsedForHours!: string;
  colorWhenUsedForMinutes!: string;
  colorWhenNotUsed!: string;
  secondsCounterArrayStartColor!: string;
  secondsCounterArrayEndColor!: string;
  ...
  //   2
  //   );
  private secondsColorArray: string[] = [];

  ngOnInit() {
    // Initialize colors from the service
    this.updateColorsFromService();
  ...
  updateColorsFromService(): void {
    const colors = this.colorService.getClockColors();
    ...
    // Regenerate seconds color array
